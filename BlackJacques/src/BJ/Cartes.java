...
public class Cartes {
	...
	public void initialisation() throws IOException {
        ...
        System.out.println("-2) Testez la difference entre les bots.\n");
        do {
        	try {	
	...
	public void resultat() {
        for (int i=0;i<nbparticipants;i++) {
            ...
            // Cas du if pour la main non split
        		System.out.println("\n" + joueurs[i].getNom() + " possede la première main :" + joueurs[i].getMainStr() + "(" + joueurs[i].total() + ")");
        		System.out.println("\n" + joueurs[i].getNom() + " possede la seconde main :" + joueurs[i].getMainSplitstr() + "(" + joueurs[i].totalMainSplit() + ")");
            	if (joueurs[i].getHasBj() && total() != 21) { // On va regarder tous les situations de fin de partie, le joueur a perdu car il depasse 21.
                    ...
                    joueurs[i].victoire();
                    System.out.println("La banque du joueur " + joueurs[i].getNom() + " est donc de sormais de " + joueurs [i].getBanque());
                    joueurs[i].addWin();
                }
                    ...
                    joueurs[i].egalite();
                    System.out.println("La banque du joueur " + joueurs[i].getNom() + " est donc desormais de " + joueurs [i].getBanque());
                }
        	...
        	// Cas si le joueur n'a pas split : 
            	...
            	System.out.println("\n" + joueurs[i].getNom() + " possede la main :" + joueurs[i].getMainStr() + "(" + joueurs[i].total() + ")");
            	System.out.println(joueurs[i].getNom() + " a eu un blackjack, il remporte 1.5x sa mise ");
                joueurs[i].blackjack();
                System.out.println("La banque du joueur " + joueurs[i].getNom() + " est donc desormais de " + joueurs[i].getBanque());
                joueurs[i].addWin();
	...
	public void afficheJoueurPourcentage() {
		for (int i = 0;i<nbparticipants;i++) {
			...
			System.out.println("\n Le joueur " + joueurs[i].getNom() + " a eu un taux de rendement de " + pourcentage*2 + "% sur 100 000 parties");
		}
	}
